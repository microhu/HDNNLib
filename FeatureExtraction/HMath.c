...
__declspec(thread) static LogDouble minLogExp;
...
float GaussDeviate(float mu, float sigma)
{
   ...
   __declspec(thread) static int gaussSaved = 0; /* GaussDeviate generates numbers in pairs */
   __declspec(thread) static float gaussSave;    /* 2nd of pair is remembered here */
